...
import { dateToDDMonYYYYTime, getBgClass } from "../../utils/utility";
...
const AccountsView = () => {
  ...
  return (
    <div className="container">
      <Row>
        {accounts &&
          [...accounts]?.reverse().map((account: any) => {
            ...
            return (
              <Col
                ...
                onClick={
                  isActive
                    ? () => handleOnClick(account.accountStatus)
                    : undefined
                }
              ...
              >
                ...
                >
                  <Card.Header
                    ...
                    style={{
                      backgroundColor: isActive ? "#1f6b6b" : "#a3abab",
                    }}
                  >
                    Account Number: {account.accountNumber}
                  </Card.Header>
                  <Card.Body>
                    <Card.Text style={{ fontSize: "0.93rem" }}>
                      <strong>Status: </strong>
                      <span
                        style={{
                          color:
                            account.accountStatus === "ACTIVE" ? "green" : "",
                        }}
                      >
                        <Badge
