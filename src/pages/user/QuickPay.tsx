    ...
    <div>
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="d-flex">
          ...
          <Form.Group
            controlId="btOtherBankAccount"
            className="py-2 ms-2 w-100"
          >
            <Form.Label>Transfer To</Form.Label>
            <Form.Control
              as="select"
              autoComplete="off"
              {...register("btOtherBankAccount", {
            ...
            <Form.Control.Feedback type="invalid">
              {typeof errors.btOtherBankAccount?.message === "string" &&
                errors.btOtherBankAccount.message}
        ...
        <div className="d-flex">
          ...
          >
            ...
            />
            <Form.Control.Feedback type="invalid">
              {typeof errors.btAmount?.message === "string" &&
                errors.btAmount.message}
            </Form.Control.Feedback>
          </Form.Group>
          <Form.Group
            controlId="btRemarks"
          ...
          >
            ...
            />
            <Form.Control.Feedback type="invalid">
              {typeof errors.btRemarks?.message === "string" &&
                errors.btRemarks.message}
            </Form.Control.Feedback>
          </Form.Group>
        </div>
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="d-flex justify-content-between">
          ...
          >
            ...
            <Form.Control
              type="text"
              autoComplete="off"
              {...register("otOtherBankAccount", {
                required: "You must provide the other bank account number.",
              })}
              isInvalid={!!errors.otOtherBankAccount}
            />
            <Form.Control.Feedback type="invalid">
              {typeof errors.otOtherBankAccount?.message === "string" &&
                errors.otOtherBankAccount.message}
            </Form.Control.Feedback>
        ...
        <div className="d-flex">
          ...
          >
            ...
            />
            <Form.Control.Feedback type="invalid">
              {typeof errors.otAmount?.message === "string" &&
                errors.otAmount.message}
            </Form.Control.Feedback>
          </Form.Group>
          <Form.Group
            controlId="otRemarks"
          ...
          >
            ...
            />
            <Form.Control.Feedback type="invalid">
              {typeof errors.otRemarks?.message === "string" &&
                errors.otRemarks.message}
            </Form.Control.Feedback>
          </Form.Group>
        </div>
        <Form.Group controlId="paymentMode" className="py-2 w-100">
  ...
  return (
    <div className="container">
      ...
      {selectedOption === "Scan & Pay" && (
        <div className="text-muted pt-5 pb-5 text-center">
          {" "}
          * We are unable to take this request on website
        </div>
      )}
